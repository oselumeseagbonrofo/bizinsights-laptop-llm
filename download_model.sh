...
# the evaluators test.
MODEL_FILE="$MODEL_DIR/qwen3.5-2B-bitext-imatrix-Q4_K_M.gguf"
MODEL_URL="https://huggingface.co/oselumese/qwen3.5-2B_lora_bitext-imatrix/resolve/34ecc594639c8f7ee19e0065f76705b0c2fb7a95/qwen3.5-2B-bitext-imatrix-Q4_K_M.gguf"
...
echo "downloading $MODEL_URL → $MODEL_FILE (~1.3 GB)…"
